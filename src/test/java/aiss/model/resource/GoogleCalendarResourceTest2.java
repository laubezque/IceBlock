...
public class GoogleCalendarResourceTest2 {
    private final static String access_token = "sadasd";
	...
	public void DeleteEvent() throws IOException  {
		...
		String idPrimerEvento = "Z698xZ2qZadDP";
		String idSegundoEvento = "Z698oak5ZadDP";
		String idTerceroEvento = "34nlnsrZ2qZadDP";
		...
		assertTrue("Error when updating the playlist", evento);
		assertTrue("Error when updating the playlist", evento2);
		assertTrue("Error when updating the playlist", evento3);
